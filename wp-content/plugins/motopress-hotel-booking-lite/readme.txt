...
* [Code Reference](https://motopress.github.io/hotel-booking-code-reference/) & [Style Kit](https://github.com/motopress/mphb-style-kit) for developers.
...
2. Add an accommodation description, image gallery, capacity, view, bed types, services and more.
3. View and sort all bookings by statuses and dates.
4. Set min and max arrival/departure rules, take accommodations out of booking.
5. Set different pricing rates based on the season, number of guests, and the length of stay.
6. Configure general settings: confirmation modes, search form fields, currency, booking calendar and more.
7. Edit admin and guest email templates for approved, pending and canceled bookings.
8. Charge full sums or deposits, enable PayPal, direct bank transfers and more gateways for your site.
9. Charge mandatory fees and taxes per accommodation or per stay.
